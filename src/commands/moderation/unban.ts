import discord, { Colors, EmbedField, Snowflake, User } from 'discord.js';
...
function makeSuccessfulUnbanEmbed(user: UserLike): discord.EmbedBuilder {
...
function makeFailedUnbanEmbed(user: UserLike, error: any): discord.EmbedBuilder {
    const fields: EmbedField[] = [];
